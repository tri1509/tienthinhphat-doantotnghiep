<?php
  $title = "Thông tin đăng nhập-salanest.";
                      ...
                      <div class="information-wrapper">
                        <form action="" method="post">
                          ...
                          <input class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" value="Đăng Nhập"
                            name="login" style="border-radius: 10px; margin-top:30px">
                          <p>Bạn mới biết đến Tiến Thịnh Phát ?
                            <a class="d-block text-center mt-2 small" href="dangky.html" style="font-size:20px">Đăng
                              ký</a>
                          </p>
                          <a class="d-block text-center mt-2 small" href="restore.html" style="font-size:15px">Bạn quên
                            mật khẩu ?</a></p>
                          <hr class="my-4">
                        </form>
                      </div>
