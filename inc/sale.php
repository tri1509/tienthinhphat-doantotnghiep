  ...
  <div class="container">
    <div class="row flex-wrap mr-mobile-left">
      <div class="col-md-3 col-sm-6 col-xs-6 col-12 fwmb bl-camket">
        <div class="flex-bw">
          <img src="img/001-delivery-truck.webp" class="img-ck">
          <div class="ct-camket">
            <p class="medi text-uppercase">Hổ Trợ Đặt Hàng & Giao hàng</p>
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 col-12 fwmb bl-camket">
        <div class="flex-bw">
          <img src="img/002-winner.webp" class="img-ck">
          <div class="ct-camket">
      ...
      <div class="col-md-3 col-sm-6 col-xs-6 col-12 fwmb bl-camket">
        <div class="flex-bw">
          <img src="img/006-24-hours-1.webp" class="img-ck">
          <div class="ct-camket">
