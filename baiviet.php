...
<div class="container">
  ...
  <ul class="khac">
    <li><i class="fa fa-angle-double-right"></i><a href="gioithieu.php"
        title="Giới Thiệu Công Ty SX TM XNK  NGK TIẾN THINH PHÁT  "> Giới Thiệu Công Ty SX TM XNK NGK TIẾN THINH PHÁT
        <span>(29/6/2022)</span></a>
    </li>
    <li><i class="fa fa-angle-double-right"></i><a href="gioithieu.php" title="CHÍNH SÁCH CHO ĐẠI LÝ BÁN HÀNG"> CHÍNH
        SÁCH MUA HÀNG & THANH TOÁN .<span>(26/07/2022)</span></a>
    </li>
  </ul>
</div>
<div id="fb-root"></div>
